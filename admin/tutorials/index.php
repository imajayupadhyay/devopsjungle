...
<div class="d-flex">
    ...
    <div class="flex-grow-1">
        ...
        <div class="container mt-4">
            <h4 class="mb-4">Manage Containers</h4>

            <!-- Add Container Form -->
            <form id="addForm" class="row g-3 mb-4" enctype="multipart/form-data">
                <div class="col-md-3">
                    <input type="text" name="title" class="form-control" placeholder="Container Title" required>
                </div>
                <div class="col-md-3">
                    <input type="text" name="description" class="form-control" placeholder="Short Description" required>
                </div>
                <div class="col-md-3">
                    <input type="url" name="link" class="form-control" placeholder="Tutorial Link (optional)">
                </div>
                <div class="col-md-2">
  ...
  <div class="modal-dialog">
    <form id="editForm" class="modal-content" enctype="multipart/form-data">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
              <input type="url" name="link" id="editLink" class="form-control" placeholder="Tutorial Link (optional)">
          </div>
          <div class="mb-3">
